<?php /* Smarty version Smarty-3.1.21-dev, created on 2014-12-03 07:39:25
         compiled from "application\views\templates\index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1112547eb01d1bfb73-11766612%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1112547eb01d1bfb73-11766612',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_547eb01d424c50_49898427',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_547eb01d424c50_49898427')) {function content_547eb01d424c50_49898427($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        ...
        <div class="navbar navbar-inverse navbar-fixed-top nave" role="navigation" >
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" id="logo" href="<?php echo $_smarty_tpl->tpl_vars['URL']->value;?>
">Quimkat</a>
                </div>
...
img/estudiante6.jpg" alt="Quimica" style="width: 140px; height: 140px;">
                        <img class="img-circle" src="<?php echo $_smarty_tpl->tpl_vars['BASE_URL']->value;?>
img/estudiante4.jpg" alt="Quimica" style="width: 140px; height: 140px;">
                        <img class="img-circle" src="<?php echo $_smarty_tpl->tpl_vars['BASE_URL']->value;?>
img/estudiante5.jpg" alt="Quimica" style="width: 140px; height: 140px;">
                    </div>
                    <div class="al_lado">
    ...
    <div class="circle" style="margin-top: 10px">
       <img class="img-circle" src="<?php echo $_smarty_tpl->tpl_vars['BASE_URL']->value;?>
img/docente.jpg" alt="Quimica" style="width: 140px; height: 140px;">
	<img class="img-circle" src="<?php echo $_smarty_tpl->tpl_vars['BASE_URL']->value;?>
img/estudiante3.jpg" alt="Quimica" style="width: 140px; height: 140px;">
<img class="img-circle" src="<?php echo $_smarty_tpl->tpl_vars['BASE_URL']->value;?>
img/colegio.jpg" alt="Quimica" style="width: 140px; height: 140px;">
      </div>
...
img/colegio.jpg" class="img-circle" style="width: 140px; height: 140px;">
	<img class="img-circle" src="<?php echo $_smarty_tpl->tpl_vars['BASE_URL']->value;?>
img/estudiante6.jpg" alt="Quimica" style="width: 140px; height: 140px;">
    ...
    <div class="modal-content letra_ubuntu">
      ...
      <div class="modal-body">
       <div class="row">
		<div class="col-md-6 mode1">
		<form ACTION="<?php echo $_smarty_tpl->tpl_vars['URL']->value;?>
usuario/usuario/insertar" METHOD="post">	
			<div class="input-group" style="margin-bottom: 5px;">
